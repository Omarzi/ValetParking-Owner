...
class AttendancesInStartScreen extends StatefulWidget {
  const AttendancesInStartScreen({super.key});

  @override
  State<AttendancesInStartScreen> createState() =>
      _AttendancesInStartScreenState();
}

class _AttendancesInStartScreenState extends State<AttendancesInStartScreen> {
    ...
    if (selectedDate != null) {
      setState(() {
        filterFromController.text =
            DateFormat('yyyy-MM-dd').format(selectedDate); // Changed format
      });
    }
  }
                ...
                child: getAttendancesInStartCubit
                    ...
                    : Column(
                        children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          ...
                                          style:
                                              VStyles.bodyLargeSemiBold(context)
                                                  .copyWith(
                                            color: VColors.whiteColor,
                                          ),
                                        ),
                          ...
                          state is GetAllAttendancesInStartLoadingState
                              ? LoadingWidget(
                                        ...
                                        children: [
                                          Text(
                                            AppLocalizations.of(context)!.translate(
                                                'noAttendanceRecordsFoundForToday')!,
