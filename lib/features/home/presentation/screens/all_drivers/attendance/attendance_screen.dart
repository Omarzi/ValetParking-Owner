      ...
      body: NestedScrollView(
        ...
        body: BlocBuilder<HomeCubit, HomeState>(
          builder: (context, state) {
            var getAttendancesCubit = HomeCubit.get(context);
            var attendancesList =
                getAttendancesCubit.getAttendanceInTodayModel.attend;

            return attendancesList == null
                ? Center(
                    child: Column(
                ...
                : attendancesList == [] || attendancesList.isEmpty
                          ...
                          child: getAttendancesCubit
                              ...
                              : Column(
                                  children: [
                                    ...
                                    //           },
                                    //           child:
                                    //               const ChoiceContainerInSuffixIcon(),
                                    //         ),
                                    ...
                                    //
                                    //                 getAttendancesCubit
                                    //                     .getAllAttendancesInStartFunction(
                                    //                   createdAtGTE:
                                    //                       filterFromController
                                    //                           .text,
                                    //                   createdAtLTE:
                                                ...
                                                return Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        '${AppLocalizations.of(context)!.translate('garagePricePerHour')} ${atte.garage!.pricePerHour} EGP',
                                                        style: VStyles
                                                            .bodyLargeSemiBold
                                                            (context).copyWith(
                                                                color: VColors
